...
const STORAGE_KEY = 'opclaude_tabs_v2';
const ACTIVE_TAB_KEY = 'opclaude_active_tab_v2';
const PERSISTENCE_ENABLED_KEY = 'opclaude_tab_persistence_enabled';
